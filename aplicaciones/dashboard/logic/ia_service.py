...
def call_ai_api(text):
    ...
    prompt = (
        ...
        f"Responde **SOLAMENTE** en formato JSON válido. La estructura debe ser: "
        f"{{\"nivel\": \"(Básico|Intermedio|Avanzado)\", \"recomendaciones\": \"Recomendación 1|Recomendación 2|Recomendación 3\"}}. "
        f"No incluyas texto adicional ni antes ni después del JSON."
